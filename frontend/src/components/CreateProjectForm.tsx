...
import type { ProjectCreationRequest, Risk } from '../features/project/project.types';
...
const CreateProjectForm = () => {
    ...
    const handleRiskChange = (index:number, field: keyof Risk, value: string | number) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        setFormData({ title: '', description: '', startDate: '', isActive: true, risks: [] });
      } catch (error) {

        console.error('Błąd podczas tworzenia projektu:', error);
        setMessage('Błąd serwera, nie udało się utworzyć projektu.');
      }
    }
