            ...
            <div className="relative bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-600 rounded-3xl p-8 text-white shadow-xl overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p className="text-purple-100 text-lg max-w-lg font-medium">
                            Masz dzisiaj <span className="text-white font-bold underline decoration-pink-400">{stats.active} aktywne projekty</span>.
                    ...
                    {user?.role === UserRole.PROJECT_MANAGER && (
                        <Button
                            ...
                            className="gap-2 bg-white text-purple-700 hover:bg-purple-50 shadow-lg px-6 py-6 text-lg font-bold rounded-2xl transition-transform hover:scale-105"
                        >
                ...
                {stats.total}
                        ...
                        <div className="flex items-center gap-2">
                            <div className="relative hidden sm:block">
                                ...
                                <input placeholder="Szukaj..." className="pl-9 pr-4 py-2 bg-gray-50 border-none rounded-xl text-sm focus:ring-2 ring-purple-500 outline-none w-48 transition-all focus:w-64" />
                            </div>
                    ...
                    {!isLoading && !isError && projects.length === 0 && (
                        <div className="text-center py-16 bg-white rounded-3xl border border-gray-100 shadow-sm">
                            ...
                            <p className="text-gray-500 mb-6 font-medium text-lg">Nie masz jeszcze żadnych projektów.</p>
                            {user?.role === UserRole.PROJECT_MANAGER && (
                                <Button onClick={() => navigate(PATHS.CREATE_PROJECT)} className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {projects.map((project) => (
                                <Link
                                    ...
                                    className="block transition-transform hover:-translate-y-1" // Dodajemy małą animację podskoku przy najechniu
                                >
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-indigo-50 rounded-2xl border border-indigo-100">
                                <div className="p-2 bg-indigo-100 w-fit rounded-lg mb-3">
                                    <Briefcase size={20} className="text-indigo-600" />
                                </div>
                                <p className="text-2xl font-black text-indigo-900">{stats.total}</p>
                                <p className="text-xs font-semibold text-indigo-600 uppercase tracking-wider">Wszystkie</p>
                            </div>
                    ...
                    <div className="bg-gray-900 rounded-3xl p-6 text-white relative overflow-hidden">
                        <div className="relative z-10">
                            <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-1">Twoja Rola</p>
